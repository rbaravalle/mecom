...
In this work we propose the application of fractal and multifractal descriptors to classify among different bread types. The results of this feature extraction procedure are shown to be both robust and simple. In section 2 we briefly introduce the theory underlying fractal sets. In section 3 (**ir completando**).
...
\begin{figure*}[htb]
\centering
$\vcenter{\hbox{\includegraphics[scale=1.3]{salvado19}}}$
$\vcenter{\hbox{\includegraphics[scale = 0.4]{fitbox}}}$
...
\begin{figure*}[htb]
\centering
$\vcenter{\hbox{\includegraphics[scale=1.3]{lactal31}}}$
$\vcenter{\hbox{\includegraphics[scale = 0.4]{emf}}}$
...
\begin{figure*}[htb]
\centering
\includegraphics[scale=1.3]{baguette20}
\includegraphics[scale=1.3]{lactal14}
\includegraphics[scale=1.3]{salvado43}
\includegraphics[scale=1.3]{sandwich43}
...
\centering
\includegraphics[scale=1.3]{baguette20}
\includegraphics[scale=0.265]{baguette20bin}
\caption{Image and its binarisation}
\label{fig:binarizacion}
\end{figure*}

The code of the algorithms Box dimension, Morphological fractal dimension and the multifractal spectrum was written and run in Matlab. The library TreeBagger was used to do a Random Forest classification. In the case of support vector machines, {\em libsvm} was used.
