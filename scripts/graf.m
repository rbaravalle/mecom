...
% Auto-generated by MATLAB on 12-Mar-2012 18:02:13

% Set up figure to receive data sets and fits
f_ = clf;
figure(f_);
set(f_,'Units','Pixels','Position',[490 209 688 484]);
...
if all(isfinite(xlim_))
    ...
    set(ax_, 'XLim',[-0.077007477945117988605, 7.7777552724569165576]);
end
...
% data.
%    cv_ = { -0.68438424583657375688, 7.261320520616971308};
%    cf_ = cfit(ft_,cv_{:});
